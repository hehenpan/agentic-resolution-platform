...
from tests.conftest import TEST_TENANT_ADMIN_EMAIL, TEST_TENANT_ADMIN_PASSWORD
from utils.commons import get_bytes_md5

def test_upload_file_success(client, db_session: Session):
    """
    Test uploading a file as tenant_admin:
    ...
    6. Clean up the physical file on disk.
    """
    # Step 1: Login
    login_payload = {
    ...
    # Step 2: Upload file
    file_content = b"This is a test upload file content."
    files = {
        "file": ("test_upload_file.txt", file_content, "text/plain")
    }
    ...
    assert file_name == "test_upload_file.txt"
    ...
    assert file_info.file_name == "test_upload_file.txt"
    ...
    # Step 6: Cleanup physical test file
